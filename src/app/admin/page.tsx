      ...
      <div className="flex flex-1 flex-wrap mt-8 gap-4 p-6">
        ...
        <aside className="w-full md:w-64 bg-gray-800 text-white p-6 rounded-lg shadow-md">
          ...
          <nav className="space-y-4">
            <Link href="/admin/Dashboard/application" className="block hover:text-gray-400">
              📋 View Applicants
            </Link>
            <Link href="/admin/Dashboard/viewdelete" className="block hover:text-gray-400">
              🗂️ View/Delete Projects
            </Link>
            <Link href="/Admin/Dashboard/assigview" className="block hover:text-gray-400">
              🧮 Assign/View Marks
            </Link>
            {/* Removed Profile & Deadlines link */}
            <Link href="/admin/dashboard/setting" className="block hover:text-gray-400">
              ⚙️ Settings
            </Link>
            <Link href="/admin/Adashboard/Message" className="block hover:text-gray-400">
              🔔 Notifications
            </Link>
