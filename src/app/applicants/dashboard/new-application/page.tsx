...
const Page: React.FC = () => {
  ...
  // Detailed project information state
  ...
  // Handler for additional "More Information" file upload
    ...
    try {
      ...
      const response = await fetch("/api/application", {
        ...
        body: JSON.stringify({
          ...
          contactPersonIfNotLegal: formData.contactPersonIfNotLegal,
          projectPartners: formData.projectPartners,
          projectTeamMembers: formData.projectTeamMembers,
          projectTitle: formData.projectTitle,
          placeOfImplementation: formData.placeOfImplementation,
          startDate: formData.startDate,
          endDate: formData.endDate,
          projectDescription: formData.projectDescription,
          projectMainObjective: formData.projectMainObjective,
        ...
        <form onSubmit={handleStep2Next} className="space-y-6">
          ...
          <div className="text-sm text-black">
            <p>
              ...
              <a
                href="https://unesco.rw/IMG/pdf/pp_project_2022-23.pdf"
                target="_blank"
