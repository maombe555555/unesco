...
interface ActivityItem {
  _id: string
  userId: string
  type: "login" | "logout" | "password_change" | "profile_update" | "application_submitted" | "security_alert"
  ipAddress: string
  userAgent: string
  timestamp: string
  details?: string
...
export default function ActivityLog({ userId }: ActivityLogProps) {
  ...
  const mockActivities: ActivityItem[] = [
    ...
    },
    {
      ...
      details: "Submitted application for UNESCO program",
    },
    {
      _id: "4",
      userId,
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Recent account activity and application events</CardDescription>
      </CardHeader>
      <CardContent>
        {loading ? (
